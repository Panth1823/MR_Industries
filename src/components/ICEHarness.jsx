...
const ICEHarness = ({ onLinkClick }) => {
  ...
  const items = [{ img: PIGTAIL_HARNESS_ICE_Vehicle_Harness_MR_Industries }];
    ...
    <>
      <div className="p-service-details-main">
        ...
        <div className="p-mobile-title">
          ...
          <p>
            {" "}
            Employing advanced wire cutting and stripping machines, precision
            crimping, and automated soldering processes, we craft high-quality
            Internal Combustion Engine (ICE) vehicle harnesses.{" "}
          </p>
        </div>
